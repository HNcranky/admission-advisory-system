...
\begin{lstlisting}[style=promptstyle,caption={Intent-router system prompt},label=lst:prompt-intent]
...
\begin{lstlisting}[style=promptstyle,caption={Knowledge question-answering system prompt},label=lst:prompt-knowledge]
...
\begin{lstlisting}[style=promptstyle,caption={Hybrid-comparison synthesis system prompt},label=lst:prompt-synthesis]
...
\begin{lstlisting}[style=promptstyle,caption={Profile delta-update system prompt},label=lst:prompt-delta]
...
\begin{lstlisting}[style=promptstyle,caption={Initial profile-extraction system prompt},label=lst:prompt-profile]
...
\begin{lstlisting}[style=promptstyle,caption={Follow-up reasoning system prompt},label=lst:prompt-followup]
...
\begin{lstlisting}[style=promptstyle,caption={Policy-interpretation system prompt},label=lst:prompt-policy]
